...
// Create class Course with properties from the courses in database such as id, code, name, progression and syllabus as well as properties with the database connection.
class Course {
	...
	// Method to get all courses from the database. Returns the result as an array.
	...
	// Method to get a specific course with id sent. Return the result as an array.
	...
	// Method to create a new course. Send code, name, progression and syllabus to the database and return true if the query went through.
	...
	// Method to update an existing course with id sent. Send code, name, progression and syllabus and set values on the course with the id sent. Return true if the query went through.
